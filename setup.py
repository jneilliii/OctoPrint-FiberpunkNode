...
plugin_identifier = "fiberpunknode"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_fiberpunknode"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Fiberpunk Node"
...
# module
plugin_description = """Plugin allows interaction with Fiberpunk Node hardware."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-FiberpunkNode"
